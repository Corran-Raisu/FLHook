...
void LoadSettings()
{
	...
	//Depecrated PlayerRestriction RepairGun handling. Use BalanceMagic handling instead.
...
EXPORT PLUGIN_INFO* Get_PluginInfo()
{
	...
	//p_PI->lstHooks.push_back(PLUGIN_HOOKINFO((FARPROC*)&HkCb_AddDmgEntry_AFTER, PLUGIN_HkCb_AddDmgEntry_AFTER, 0)); //Depecrated PlayerRestriction RepairGun handling. Use BalanceMagic handling instead.
